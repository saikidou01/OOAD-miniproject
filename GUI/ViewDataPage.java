...
public class ViewDataPage extends JFrame {
    ...
    private String propertyColumns[] = { "Property ID", "Address", "Quadrant", "Type", "#ofBeds", "#ofBaths",
            "Furnished", "Fees", "Fees Paid", "Status", "Landlord ID", "Start Date", "End Date", "Fee Period",
            "Rent Date" };
